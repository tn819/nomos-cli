...
function printEverything(version = getLatestVersion()) {
...
program
    ...
    const result = await sdk.call(operation, {
        path: parseJsonObject(opts.path),
        query: parseJsonObject(opts.query),
...
program
    ...
    const body = { grant_type: opts.grantType };
    if (opts.code)
        body.code = opts.code;
